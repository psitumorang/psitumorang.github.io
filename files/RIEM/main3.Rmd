...
write_csv(summary, 'C:\\Users\\Philip.Situmorang\\Desktop\\RIEM\\1.1 - Main\\Period 3\\summary_slopes_period3_new.csv')
```
...
write_csv(summary_all, 'C:\\Users\\Philip.Situmorang\\Desktop\\RIEM\\1.1 - Main\\Period 3\\summary_slopes_period3_all.csv')
```
...
```{r}
summary1 <- data.frame(group, decile, ir_thresholds, crashes_pvtd, num_a_carriers,num_b_carriers, avg_crc_a, avg_crc_b, benchmark)
...
```
```{r}
summary2 <- data.frame(group, decile, ir_thresholds, crashes_pvtd, num_a_carriers,num_b_carriers, avg_crc_a, avg_crc_b, benchmark)
...
```{r}
summary3 <- data.frame(group, decile, ir_thresholds, crashes_pvtd, num_a_carriers,num_b_carriers, avg_crc_a, avg_crc_b, benchmark)
...
```{r}
summary4 <- data.frame(group, decile, ir_thresholds, crashes_pvtd, num_a_carriers,num_b_carriers, avg_crc_a, avg_crc_b, benchmark)
